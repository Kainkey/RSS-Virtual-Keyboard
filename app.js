...
const keyboardLayout = [
  ...
  specialKeys.forEach(key => {
    if (key.textContent === 'Tab' || key.textContent === 'Caps Lock' || key.textContent === 'Enter' || key.textContent === 'Shift' || key.textContent === 'Backspace' || key.textContent === 'Delete' || key.textContent === 'Space') {
      key.classList.add(key.textContent.toLowerCase() + '-key');
    }
  });
